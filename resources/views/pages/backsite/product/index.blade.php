                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse hide">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.product.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name" class="form-control" placeholder="example Hidrococo or Kusuka" value="{{old('name')}}" autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="type" name="type" class="form-control" placeholder="example Makanan or Minuman" value="{{old('type')}}" autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="qty" name="qty" class="form-control" placeholder="example 10" value="{{old('qty')}}" autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="price" name="price" class="form-control" placeholder="example price 10000" value="{{old('price')}}" autocomplete="off" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits': 0, 'digitsOptional': 0, 'prefix': 'Rp ', 'placeholder': '0'" required>
                                                ...
                                                <tbody>
                                                    @forelse($product as $key => $product_item)
                                                        <tr data-entry-id="{{ $product_item->id }}">
                                                            <td>{{ isset($product_item->created_at) ? date("d/m/Y H:i:s",strtotime($product_item->created_at)) : '' }}</td>
                                                            <td>{{ $product_item->name ?? '' }}</td>
                                                            <td>{{ $product_item->type ?? '' }}</td>
                                                            <td>{{ $product_item->qty ?? '' }}</td>
                                                            <td>{{ 'Rp '.number_format($product_item->price) ?? '' }}</td>
                                                            <td><a data-fancybox="gallery" data-src="{{ request()->getSchemeAndHttpHost().'/storage'.'/'.$product_item->photo }}" class="blue accent-4">Show</a></td>
                                                            <td class="text-center">
                                                                ...
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <a href="#mymodal"
                                                                            data-remote="{{ route('backsite.product.show', $product_item->id) }}"
                                                                            data-toggle="modal"
                                                                            data-target="#mymodal"
                                                                        ...
                                                                        <a class="dropdown-item" href="{{ route('backsite.product.edit', $product_item->id) }}">
                                                                            Edit
                                                                        </a>

                                                                        <form action="{{ route('backsite.product.destroy', $product_item->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
